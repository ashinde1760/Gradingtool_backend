...
/**
 * A POJO which is having the details of the ParameterRatingTable table.
 *
 */
public class ParameterRatingTable {
	...
	public String toString() {
		return "ParameterRatingTable [id=" + id + ", formId=" + formId + ", sectionId=" + sectionId + ", parameterId="
				+ parameterId + ", maxmarks=" + maxmarks + ", saScore=" + saScore + ", faScore=" + faScore
				+ ", variance=" + variance + "]";
	}
