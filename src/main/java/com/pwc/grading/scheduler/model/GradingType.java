...
//	private long selfAssessmentDeadLine;
	...
	public boolean isSelfAssignmentStatus() {
...
//	}
	...
	public String toString() {
		return "GradingType [projectId=" + projectId + ", formId=" + formId + ", partnerId=" + partnerId
				+ ", selfAssignmentStatus=" + selfAssignmentStatus + ", fieldAuditorId=" + fieldAuditorId
				+ ", auditDate=" + auditDate + ", auditStatus=" + auditStatus + ", isAuditCancled=" + isAuditCancled
				+ ", secondaryFieldAuditorName=" + secondaryFieldAuditorName + "]";
	}
